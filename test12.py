...
#Sonidos
pygame.mixer.init()
laser = pygame.mixer.Sound('sonido/laser.ogg')

# sonido_random = [pygame.mixer.Sound('sonido/laser.ogg'),
#                  pygame.mixer.Sound('sonido/laser.ogg'),
#                  pygame.mixer.Sound('sonido/laser.ogg'),
#                  pygame.mixer.Sound('sonido/laser.ogg')]
# (Se ejecuta el sonido con lo siguiente)
#
# sonido_random[random.randrange(0, 3)].play()
