...
#Fondo del juego
fondo = pygame.image.load('img/ciudad.png')
...
#Personaje
quieto = pygame.image.load('principal/idle1.png')

caminaDerecha = [pygame.image.load('principal/run1.png'),
                 pygame.image.load('principal/run2.png'),
                 pygame.image.load('principal/run3.png'),
                 pygame.image.load('principal/run4.png'),
                 pygame.image.load('principal/run5.png'),
                 pygame.image.load('principal/run6.png')]

caminaIzquierda = [pygame.image.load('principal/run1-izq.png'),
                   pygame.image.load('principal/run2-izq.png'),
                   pygame.image.load('principal/run3-izq.png'),
                   pygame.image.load('principal/run4-izq.png'),
                   pygame.image.load('principal/run5-izq.png'),
                   pygame.image.load('principal/run6-izq.png')]

salta = [pygame.image.load('principal/jump1.png'),
         pygame.image.load('principal/jump2.png')]
